...
#define OLED_SDA_Clr() GPIO_ResetBits(GPIOA,GPIO_Pin_12)//SDA
#define OLED_SDA_Set() GPIO_SetBits(GPIOA,GPIO_Pin_12)

#define OLED_RES_Clr() GPIO_ResetBits(GPIOA,GPIO_Pin_15)//RES
#define OLED_RES_Set() GPIO_SetBits(GPIOA,GPIO_Pin_15)


#define OLED_CMD  0	//写命令#define OLED_DATA 1	//写数据
